ROOMS = {
    ...
    'treasure_room': {
     ...
     'observatory': {
        'description': 'Звёздная обсерватория под куполом. '
        'На столе лежит звёздная карта.',
        'exits': {'south': 'armory', 'east': 'kitchen'},
        'items': ['star_map'],
        'puzzle': ('На карте вы видите надпись: '
        '"Сколько планет в Солнечной системе?" (ответ цифрой)', '8')
    },
    'kitchen': {
        'description': 'Отвратно пахнущая кухня. '
        'На столе лежит ржавый нож, '
        'рядом с ним заплесневелая головка сыра',
...
COMMANDS = {
    ...
    "steps": "показать количество пройденных шагов",
    "quit": "выйти из игры",
